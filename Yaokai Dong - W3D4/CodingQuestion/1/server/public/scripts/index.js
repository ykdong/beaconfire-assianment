...
// create a variable to hold the old title for current item
let oldTitle;
itemTable && itemTable.addEventListener("click", (e) => {
  ...
  // event listener for modify a todo item
    ...
    // get old title for current todo item
    oldTitle = document.getElementById(`title${e.target.value}`).innerText;
